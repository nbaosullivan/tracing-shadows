...
const Header = ({ siteTitle }) => (
  <div className={'relative h-screen w-full flex flex-col justify-between'}>
    ...
    <div className=" w-full h-full relative">
      ...
      <div className={'bg-black opacity-90 absolute z-30 border-8 inset-0 border-white'}>
    ...
    <div className="bg-white">
      <div className="w-full md:px-44 bg-white py-12 px-5 mx-auto md:flex items-end justify-between -mt-6 space-y-8 md:space-y-0">
