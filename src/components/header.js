...
const Header = ({ siteTitle }) => (
  <div className={'relative h-screen w-full flex flex-col justify-between'}>
    ...
    <div className="bg-white">
      <div className="w-full md:px-44 bg-white py-12 px-5 mx-auto md:flex items-center justify-between -mt-6">
        ...
        <div className={'w-full md:w-1/3 text-center'}>
          <p className={'mb-5 text-gray-700'}>Tracing Shadows - Out now</p>
          <Button>Stream it</Button>
        </div>
        <div className={'w-full md:w-1/3 text-right flex items-end justify-end'}>
